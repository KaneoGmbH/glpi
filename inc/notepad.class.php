   ...
   **/
   static function showForItem(CommonDBTM $item, $withtemplate='') {
      ...
      if ($canedit) {
         ...
         echo "<textarea class='form-control'  name='content' rows=5 cols=100></textarea>";
         echo "</div>";
         ...
         foreach ($notes as $note) {
            ...
            echo "</div>"; // boxnote
             ...
             if ($canedit) {
                ...
                echo "<textarea class='form-control'  name='content' rows=5 cols=100>".$note['content']."</textarea>";
                echo "</div>"; // boxnotecontent
