...
class AuthLDAP extends CommonDBTM {
   ...
   function showForm($ID, $options=array()) {
      ...
      if (Toolbox::canUseLdap()) {
         ...
         if (empty($ID)) {
            ...
            echo "<tr ><td>".__('Preconfiguration')."</td> ";
            echo "<td colspan='3'>";
         ...
         echo "<tr ><td>" . __('Default server') . "</td>";
         echo "<td>";
   ...
   function showFormReplicatesConfig() {
      ...
      if (($nb = $DB->numrows($result)) > 0) {
         ...
         while ($ldap_replicate = $DB->fetch_assoc($result)) {
            echo "<tr ><td class='center' width='10'>";
   ...
   **/
   ...
   function showFormGroupsConfig() {
      ...
      echo "<tr ><td>" . __('Search type') . "</td><td>";
      ...
      echo "<tr ><td>" . __('Filter to search in groups')."</td><td colspan='3'>";
      echo "<input type='text' name='group_condition' value='".$this->fields["group_condition"]."'
             size='100'>";
      echo "</td></tr>";

      echo "<tr ><td>" . __('Group attribute containing its users') . "</td>";
   ...
   function showFormEntityConfig() {
      ...
      echo "<tr ><td>" . __('Attribute representing entity') . "</td>";
      echo "<td colspan='3'>";
      echo "<input type='text' name='entity_field' value='".$this->fields["entity_field"]."'>";
      echo "</td></tr>";

      echo "<tr ><td>" . __('Search filter for entities') . "</td>";
      echo "<td colspan='3'>";
   ...
   **/
   static function ldapChooseDirectory($target) {
      ...
      echo "<table class='table'>";
      echo "<tr ><th colspan='2'>" . __('LDAP directory choice') . "</th></tr>";
      ...
      switch ($_SESSION['ldap_import']['interface']) {
         case self::EXPERT_INTERFACE :
            ...
            if (($_SESSION['ldap_import']['authldaps_id'] !=  NOT_AVAILABLE)
               ...
               if (self::getNumberOfServers() > 1) {
                  echo "<tr ><td>".__('LDAP directory choice')."</td>";
                  echo "<td colspan='3'>";
         ...
         default :
            ...
            if (Session::isMultiEntitiesMode()
               ...
               echo "<tr ><td>".__('Select the desired entity')."</td>".
                    "<td colspan='3'>";
