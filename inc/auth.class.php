      ...
      if (Session::haveRight("user", User::UPDATEAUTHENT)) {
         ...
         switch($user->getField('authtype')) {
            ...
            case self::LDAP :
               ...
               $result = $DB->query($sql);
               if ($DB->numrows($result) > 0) {
                  echo "<table class='table table-striped table-hover'><tr class='tab_bg_1'><td>";
   ...
   **/
   static function showOtherAuthList() {
      ...
      if (function_exists('curl_init')) {
         ...
         echo "<tr class='tab_bg_1'><td class='center'>" . __('CAS Host') . "</td>";
         echo "<td><input type='text' name='cas_host' value=\"".$CFG_GLPI["cas_host"]."\"></td></tr>\n";
         //TRANS: for CAS SSO system
         echo "<tr class='tab_bg_1'><td class='center'>" . __('Port') . "</td>";
         echo "<td><input type='text' name='cas_port' value=\"".$CFG_GLPI["cas_port"]."\"></td></tr>\n";
         //TRANS: for CAS SSO system
         echo "<tr class='tab_bg_1'><td class='center'>" . __('Root directory (optional)')."</td>";
         echo "<td><input type='text' name='cas_uri' value=\"".$CFG_GLPI["cas_uri"]."\"></td></tr>\n";
         //TRANS: for CAS SSO system
         echo "<tr class='tab_bg_1'><td class='center'>" . __('Log out fallback URL') . "</td>";
