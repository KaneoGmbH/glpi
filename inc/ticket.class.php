...
//       "<div id='uploadfiles'><input type='file' name='filename[]' value='' size='60'></div>";
   ...
   **/
   ...
   function showForm($ID, $options=array()) {
      ...
      $template->assign('canupdate',$canupdate);
      $template->assign('showuserlink',$showuserlink);
      $template->assign('canupdate_descr',$canupdate_descr);
      $template->assign('values',$values);
      $template->assign('canstatus',$canstatus);
      $template->assign('canpriority',$canpriority);
         ...
         if ($showgrouptickets) {
            ...
            switch ($status) {
               ...
               case "tovalidate" :
                  ...
                  $title = __('Your tickets to validate');
               ...
               case "rejected" :
                  ...
                  $title = __('Your rejected tickets');
          ...
          echo "<h4>";
          echo $title;
          echo " <a href=\"".$CFG_GLPI["root_doc"]."/front/ticket.php?".Toolbox::append_params($options,'&amp;')."\">";
